**Write a Ruby program that shows the current date and time at the beginning. Then takes a string of words and prints the word which has the maximum repeatations.
